Установочный BAT-файл "ComfyUI+SUPIR" для карт "NVIDIA" для ноды версии "v1".
...
Создайте пустой каталог (к примеру "c:\1") с скопируйте туда все файлы из git-архива:
...
После старта интерфейса загрузите на рабочий стол "ComfyUI" файл "supir_workflow_v1.json", а в ноду "Load Image" файл "example.jpg" для тестирования.
